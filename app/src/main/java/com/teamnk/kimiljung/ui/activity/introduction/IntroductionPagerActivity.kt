...
import com.teamnk.kimiljung.util.SharedPreferencesName.INTRODUCTION_PAGE
...
class IntroductionPagerActivity : BaseActivity<ActivityIntroductionPagerBinding>(
    ...
    private val sharedPreferences by lazy {
        initializeSharedPreferences(this, INTRODUCTION_PAGE, MODE_PRIVATE)
    }
    ...
    private fun checkIntroductionPageShown() {
        if (sharedPreferences.getBoolean(IS_INTRODUCTION_PAGER_ACTIVITY_SHOWN, false)) {
            moveToStartActivity()
        }
    }
        ...
        binding.viewGroupIntroductionNext.setOnClickListener {
            ...
            if (current == 3) {
                ...
                putInSharedPreferences(
                    sharedPreferencesEditor, IS_INTRODUCTION_PAGER_ACTIVITY_SHOWN, true
                )
            }
        }
    }
